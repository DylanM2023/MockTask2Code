...
const Home = () => {
    ...
    return ( 
    <>
        <div className="h-auto w-auto bg-no-repeat bg-cover border-0">
            <NavBar/>
            <div className="desktop:place-items-center">
                <div className="bg-otter_image w-auto m-10 h-60 bg-no-repeat bg-cover border-2 border-black bg-center desktop:w-2/3 desktop:h-96"></div>
                    ...
                    <div className="bg-lion_image w-auto m-10 h-60 bg-no-repeat bg-cover border-2 border-black bg-center desktop:w-2/3 desktop:h-96 "></div>
                    <p className="m-10 text-white bg-slate-600 bg-opacity-80 border-2 border-black px-1 desktop:w-2/3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus reprehenderit quae pariatur recusandae tempora, placeat ad doloremque laboriosam vero et fugiat esse cum vitae temporibus iste labore! Possimus, a dolorum!</p>
                    <div className="bg-bird_image w-auto m-10 h-60 bg-no-repeat bg-cover border-2 border-black bg-center desktop:w-2/3 desktop:h-96"></div>
